...
class Get_friends(object):
    ...
    def get_friends(self, qq, cookie, db):
        ...
        url = 'https://h5.qzone.qq.com/proxy/domain/r.qzone.qq.com/cgi-bin/tfriend/friend_show_qqfriends.cgi?uin=' + \
    ...
    def get_friends_detail(self, qq, cookie, qq_num):
        ...
        url = 'https://h5.qzone.qq.com/proxy/domain/base.qzone.qq.com/cgi-bin/user/cgi_userinfo_get_all?uin=' + \
            str(qq_num) + '&fupdate=1&outCharset=utf-8&g_tk=' + g_tk
        header = self.header
        r = s.get(url, headers=header)
    ...
    def operate_db_friends(self, db, tablename, data):
        ...
        create_tb_sql = 'CREATE TABLE IF NOT EXISTS %s (\
            ...
            online int(2), \
            v6 int(2) \
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4' % tablename        # change mysql encoding to support emoji
